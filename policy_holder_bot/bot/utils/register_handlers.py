...
from bot.handlers.authorization_handler import authorization_handler, email_handler, verify_code, REQUEST_EMAIL, REQUEST_VERIFICATION_CODE
...
from bot.handlers.request_payout_handler import request_payout_handler, approve_access, request_policy_number, request_crypto_wallet, request_diagnosis_code, request_diagnosis_date, APPROVE_ACCESS, REQUEST_CRYPTO_WALLET, REQUEST_DIAGNOSIS_CODE, REQUEST_DIAGNOSIS_TIME, REQUEST_POLICY_NUMBER
...
def register_handlers(application: Application):
    ...
    conversation_handler = ConversationHandler(
        ...
        states={
            REQUEST_EMAIL: [MessageHandler(filters.TEXT & ~filters.COMMAND, email_handler)],
